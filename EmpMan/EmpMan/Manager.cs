...
// Responsible for all processing related to a Manager
...
namespace EmpMan
{
    // Manager inherits the data and methods in Person
    ...
    class Manager : Employee
    {
        ...
        public Manager(string name, string birthdate, string id, string jt, Decimal s,
        Decimal b) : base(name, birthdate, id, jt)
        {
